...
Parts for this kits are made to snap and fit together without glue, so you will
sometimes need to apply quite a bit of force to push the parts together. To do
so, apply presure progessively vertically on pre aligned parts.
