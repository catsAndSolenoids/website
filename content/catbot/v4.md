...
![img caption](/assets/build/yld/01.png)
![img caption](/assets/build/yld/02.png)
### step 2
Same thing with the bottom part, servo wire facing upward in the little additional "U" shaped hole
![img caption](/assets/build/yld/03.png)
![img caption](/assets/build/yld/04.png)
### step 3
Place the 'E' shaped bit in the top notches
![img caption](/assets/build/yld/05.png)
![img caption](/assets/build/yld/06.png)
### step 4
Now place the top part on the circular base
![img caption](/assets/build/yld/07.png)
![img caption](/assets/build/yld/08.png)
### step 5
these two bit will hold the turret in place, you may need to force a bit to make these one s fit in.
![img caption](/assets/build/yld/09.png)
![img caption](/assets/build/yld/10.png)
### step 6
...
![img caption](/assets/build/yld/12.png)
![img caption](/assets/build/yld/13.png)
### step 7
insert the laser (the dark grey cylinder in the pict) in the wooden bit
![img caption](/assets/build/yld/14.png)
top part is now complete
![img caption](/assets/build/yld/15.png)
### step 8
Now we will start the base by placing the funduino on it
![img caption](/assets/build/yld/16.png)
![img caption](/assets/build/yld/17.png)
![img caption](/assets/build/yld/18.png)
![img caption](/assets/build/yld/19.png)
![img caption](/assets/build/yld/20.png)
### step 9
...
![img caption](/assets/build/yld/21.png)
![img caption](/assets/build/yld/22.png)
### step 10
Now place bar B, take care that the notches from the two part matches sides and are on the left
![img caption](/assets/build/yld/23.png)
![img caption](/assets/build/yld/24.png)
### step 11
then place the servo, servo gear should be centered, if not turn both bar sides
![img caption](/assets/build/yld/25.png)
![img caption](/assets/build/yld/26.png)
### step 12
Next is the C bar, with the notches aligned
![img caption](/assets/build/yld/27.png)
![img caption](/assets/build/yld/28.png)
### step 13
...
![img caption](/assets/build/yld/29.png)
![img caption](/assets/build/yld/30.png)
### step 14
now put the top part on the base sevo, gear, and you are done !!! ta da !
![img caption](/assets/build/yld/31.png)
